...
#dat %>% 
 # ggplot() + geom_sf(aes(fill = debt_share, geometry = geometry)) + geom_sf_text(aes(label = label, geometry = geometry), size = 3) + theme_void() + scale_fill_gradientn(colours = colours, name = "Schuldenquote") + theme(panel.grid.major = element_line(color = "white"))
# enter your code here ...
...
# enter your code here ...
#cor(unempl, debt_share_country_pro, use="pairwise.complete.obs") 
eu_makro %>% 
cor(unempl, debt_share_country_pro = NULL, use = "pairwise.complete.obs")
